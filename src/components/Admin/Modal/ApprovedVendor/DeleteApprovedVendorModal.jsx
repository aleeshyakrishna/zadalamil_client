...
export function DeleteAprovedVendorModal({ open, setOpen, deleteVendor }) {
            ...
            <div className='p-6'>
                <DialogHeader>
                    <div className="flex justify-between w-full">
                        <span className="text-xl font-bold">Confirm Delete Vendor</span>
                        <Button
                            variant="text"
                            color="black"
                ...
                <DialogBody>
                    <div className="flex justify-between w-full">
                        <h3>Are you sure you want to delete the Vendor?</h3>
                    </div>
                </DialogBody>
...
DeleteAprovedVendorModal.propTypes = {
