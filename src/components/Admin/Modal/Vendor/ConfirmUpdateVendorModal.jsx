...
export function ConfirmEditVendorDetailsModal({ open, setOpen, saveDetails }) {
  return (
    <Dialog
        open={open}
        ...
        <div className='p-6'>
            <DialogHeader>
                <div className="flex justify-between w-full">
                    <span className="text-xl font-bold">Confirm Update Status</span>
                    <Button
                    variant="text"
                    color="black"
...
ConfirmEditVendorDetailsModal.propTypes = {
