...
const navListMenuItemsGrow = [
    {
      title: "Advertizing on Zad Alamil",
...
function NavListGrow() {
    const [isMenuOpen, setIsMenuOpen] = React.useState(false);
    const [isMobileMenuOpen, setIsMobileMenuOpen] = React.useState(false);
    const renderItems = navListMenuItemsGrow.map(
    ({ icon, title }, key) => (
        <a href="#" key={key}>
        <MenuItem className="flex items-center gap-3 rounded-lg">
            <div className="flex items-center justify-center rounded-lg !bg-blue-gray-50 p-2 ">
        ...
        <Navbar className="max-w-none rounded-none z-50 bg-[#f6f6f6] h-20 fixed">
            <div className="relative mx-auto flex items-center justify-between text-blue-gray-900">
                ...
                {/* <Button variant="text" size="sm" color="blue-gray">
                    ...
                    <Button  size="sm" className="bg-red-900">
                        Sign In
                    </Button>
                </div>
                <IconButton
            ...
            <Collapse open={openNav}>
                ...
                {/* <Button variant="outlined" size="sm" color="blue-gray" fullWidth>
                    ...
                    <Button className="bg-red-900" size="sm" fullWidth>
                        Sign In
                    </Button>
                </div>
            </Collapse>
